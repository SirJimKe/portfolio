...
| Pick a teammate | Teammate not picked yet | |
...
<!-- Fill out the daily scrum table 
  -- Doing today? - Setting Integrated Development Environment
  -- Objective?   - Have my machine ready for the project
  -- Blockers?    - Errors when running the server
-->
...
|----------	|-------	|--------	|
| Choose a project | Chosen | https://github.com/italanta/elewa-group |
| Choose an issue | Issue Chosen | https://github.com/italanta/elewa-group/issues/38 |
...
- [c] Connect *< Elewa or Kujali >* to firebase
...
- My mood this week was overwhelmed because I had alot to learn.
